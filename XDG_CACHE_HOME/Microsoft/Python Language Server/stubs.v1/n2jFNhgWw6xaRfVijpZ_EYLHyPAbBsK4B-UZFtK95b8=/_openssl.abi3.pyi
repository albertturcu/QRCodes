...
__doc__ = None
__file__ = '/home/albert/anaconda3/lib/python3.7/site-packages/cryptography/hazmat/bindings/_openssl.abi3.so'
...
class lib(_mod_builtins.object):
    ...
    def PEM_read_bio_DSAPrivateKey():
        'DSA *PEM_read_bio_DSAPrivateKey(BIO *, DSA * *, int(*)(char *, int, int, void *), void *);\n\nCFFI C function from _openssl.lib'
        pass
    
    @staticmethod
    def PEM_read_bio_DSA_PUBKEY():
        'DSA *PEM_read_bio_DSA_PUBKEY(BIO *, DSA * *, int(*)(char *, int, int, void *), void *);\n\nCFFI C function from _openssl.lib'
        pass
    ...
    def PEM_read_bio_RSAPrivateKey():
        'RSA *PEM_read_bio_RSAPrivateKey(BIO *, RSA * *, int(*)(char *, int, int, void *), void *);\n\nCFFI C function from _openssl.lib'
        pass
